...
public class ProjetoDAO {
	...
	// Realiza o cadastro de um projeto no banco de dados passando os valores
	// inseridos pelo usuário na tela de informações do projeto,
	...
	// Exclui um projeto da tabela, usando como parâmetro o id de projeto presente
	// na tabela de inscirção dele,
	// em que seu id é uma chave estrangeira
