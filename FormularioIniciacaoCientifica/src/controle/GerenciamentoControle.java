...
public class GerenciamentoControle {
	...
	// Instanciando e inicializando a classe DAO utilizada, para que não seja
	// nescessário que ela seja passada por parâmetro
	private InscricaoDAO inscricaoDao = new InscricaoDAO();

	public GerenciamentoControle() {
	};

	// Pega o ArrayList que vem da classe DAO para realizar o preenhimento da
	// tabela. Cada posição do ArrayList representa uma linha da tabela
