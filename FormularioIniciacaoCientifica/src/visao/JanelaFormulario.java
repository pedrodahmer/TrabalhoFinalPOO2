...
public class JanelaFormulario extends JPanel {
	...
	public JanelaFormulario() {
		...
		tabbedPane.addTab("Dados do aluno", new ImageIcon(JanelaExecucao.class.getResource("/imagens/icon-aluno.png")),
				pnlDadosAluno, null);
		pnlDadosAluno
				.setLayout(new MigLayout("", "[][252.00,grow]", "[][10.00][30.00][31.00][23.00][26.00][29.00][][]"));
		...
		// Faz com que o text field de inscrição mude de cor e fique desabilitado
		// dependendo do radio button selecionado
		...
		tabbedPane.addTab("Dados do projeto",
				new ImageIcon(JanelaExecucao.class.getResource("/imagens/icon-orientador.png")), pnlDadosProjeto, null);
		...
		tabbedPane.addTab("Dados do professor orientador",
				new ImageIcon(JanelaExecucao.class.getResource("/imagens/icon-projeto.png")), pnlDadosProf, null);
