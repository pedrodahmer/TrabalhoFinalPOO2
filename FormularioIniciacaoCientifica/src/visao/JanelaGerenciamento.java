...
public class JanelaGerenciamento extends JPanel {
	...
	public void avisoResultadoExclusao(boolean sinal) {
		...
		if(sinal) {
			...
			JOptionPane.showMessageDialog(this, "Não foi possível excluir a inscrição", "Erro", JOptionPane.ERROR_MESSAGE);
		}
		
	}
	
	public int avisoExclusao() {
		int resposta = JOptionPane.showConfirmDialog(this, "Excluir a inscrição excluirá o aluno, orientador e projeto. Prosseguir?", "Aviso", JOptionPane.WARNING_MESSAGE);
